...
class CallScreen2 extends StatefulWidget {
  final Call call;
  const CallScreen2({Key? key, required this.call}) : super(key: key);
  @override
  _CallScreenState2 createState() => _CallScreenState2();
}

class _CallScreenState2 extends State<CallScreen2> {
  final serverText = TextEditingController();
  final roomText = TextEditingController(text: "plugintestroom");
  final subjectText = TextEditingController(text: "Audio");
  late String username;
  late String email;
  final iosAppBarRGBAColor =
  TextEditingController(text: "#0080FF80"); //transparent blue
