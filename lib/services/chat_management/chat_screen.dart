...
import 'package:chat_app/frontend/call_screens/call_screen.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  @override
  void initState() {
    _loadPreviousStoredMessages(); //load previous messages from local
    _getConnectionEmail();
            ...
            onPressed: () async {
              ...
              if (callMade) {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => CallScreen2(call: call)));
              }
            },
          ),
          IconButton(
